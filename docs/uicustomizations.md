...
| `selection`                           | background color for selected text ranges                                                                                         | `--item-hover`, `--tab-hover`, `--icon-back-hover`                                                                                                           |                                      |                                                                                                                                                               |
| `line_highlight`                      | background color of code line where caret is (current line) and selected lines (bg outside of selection box/text)                 | `--button-back`, `--separator`, `--slider-button`, `--scrollbar-border`, `--tab-back`                                                                        |                                      |                                                                                                                                                               |
| `selection_region`                    | highlighted regions in batch operations such as find/replace                                                                      | `--scrollbar-hback-hover`                                                                                                                                    | `selection`                          |                                                                                                                                                               |
| `matching_bracket`                    | background highlighting of matchable operators such as bracket pairs or quotes                                                    |                                                                                                                                                              | `selection`                          |                                                                                                                                                               |
| `matching_selection`                  | selecting text will highlight the same string sequence reoccurring in the document. Background color for reoc. text.              |                                                                                                                                                              | `selection`                          |                                                                                                                                                               |
| `matching_search`                     | background color for highlighted search/find results                                                                              |                                                                                                                                                              |                                      |                                                                                                                                                               |
| `line_number`                         | color of line numbers in the gutter (inactive)                                                                                    | `--button-border`, `--slider-back`, `--tab-line`, `--menu-border`                                                                                            |                                      |                                                                                                                                                               |
| `line_number2`                        | color of the active line number(s) (see `line_highlight`)                                                                         | `--font-hint`, `--slider-border`, `--tab-close`, `--tab-font-inactive`, `--icon-line`, `--menu-font-disabled`, `--floating-icon`, `--disabled-color`         |                                      |                                                                                                                                                               |
| `whitespace`                          | color of visual whitespace markers (if enabled)                                                                                   |                                                                                                                                                              | `selection`                          |                                                                                                                                                               |
| `line_break_column`                   | color of the line breaking column (code length marker)                                                                            | `--disabled-border`                                                                                                                                          | `selection`                          |                                                                                                                                                               |
| `suggestion`                          | color control for unselected suggestion items (autocomplete/lsp popup)                                                            |                                                                                                                                                              |                                      | `foreground,background`                                                                                                                                       |
| `suggestion_selected`                 | color control for selected suggestion items                                                                                       |                                                                                                                                                              |                                      | `foreground,background`                                                                                                                                       |
| `suggestion_scrollbar`                | scrollbar in suggestion box if list is large enough                                                                               | `--scrollbar-button`                                                                                                                                         | `line_highlight`                     |                                                                                                                                                               |
| `minimap_background`                  | background of the right code minimap area                                                                                         |                                                                                                                                                              | `background`                         | transparency suggested (e.g. `#282828AA`)                                                                                                                     |
| `minimap_visible_area`                | in the code minimap, there is a rectangle marking the currently visible section. background of said rectangle.                    | `droppable-hovering-color`                                                                                                                                   |                                      |                                                                                                                                                               |
| `minimap_current_line`                | the color of `line_highlight` on the minimap                                                                                      |                                                                                                                                                              |                                      |                                                                                                                                                               |
| `minimap_hover`                       | the responsive color change when hovering mouse pointer over `minimap_visible_area`                                               |                                                                                                                                                              |                                      |                                                                                                                                                               |
| `minimap_selection`                   | color of `selection` on the minimap                                                                                               | `--highlight-primary`                                                                                                                                        |                                      |                                                                                                                                                               |
| `minimap_highlight`                   | color of search/find highlights (`matching_search`) on the minimap                                                                |                                                                                                                                                              |                                      |                                                                                                                                                               |
...
| `operator`                            | mathematical, logical or language-agnostic operators (`+-*/=!=&&\|\|`)                                                            |                                                                                                                                                              |                                      |                                                                                                                                                               |
| `function`                            | the name of a function (often before `()` parentheses)                                                                            | `--theme-success`                                                                                                                                            |                                      |                                                                                                                                                               |
| `link`                                | color of a callable/clickable hyperlink                                                                                           |                                                                                                                                                              | `function`                           |                                                                                                                                                               |
| `link_hover`                          | colors and theming when hyperlink is hovered by mouse pointer                                                                     |                                                                                                                                                              | `function`                           | list color-code -> transparency -> shaded -> underlined (modifiers enabled with adding the respective keyword);  e.g. `#282828,transparent,shadow,underline`  |

Examples can be found [here](https://github.com/SpartanJ/eepp/blob/develop/bin/assets/colorschemes/colorschemes.conf).

#### Editor Color Scheme Operators/Valid values

Next to the colors, every highlighted object can be suited with an array of modifiers to change the appearance of the text or object. These are entered in a comma-separated list without spacing.
...
- `strikethrough`
- `shadow` (outline)
- `regular` (explicitly unstyled, default)
- `outline(<color>, <thickness>)`
   - e.g. `outline(#cccccc, 0.7)`

e.g. `link_hover = #4CE0BC,bold,underline,outline(#ffffff, 0.1)`
